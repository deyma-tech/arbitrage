use crate::orca::swap::{
    math::{
        ceil_division_u128, ceil_division_u32, floor_division, sqrt_price_from_tick_index, tick_index_from_sqrt_price,
    },
    oracle::{
...
impl FeeRateManager {
    ...
    pub fn update_volatility_accumulator(&mut self) -> anyhow::Result<()> {
        match self {
            Self::Static { .. } => Ok(()),
            Self::Adaptive {
                tick_group_index,

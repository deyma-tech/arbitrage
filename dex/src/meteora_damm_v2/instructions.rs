...
// // use super::{AddLiquidityParameters, ConfigParameters, InitializeCustomizablePoolParameters};
// // #[derive(Clone, Debug, PartialEq)]
...
// //                 Ok(
// //                     Self::ClaimPartnerFee(
// //                         ClaimPartnerFeeIxArgs::deserialize(&mut reader)?,
// //                     ),
// //                 )
// //             }
...
// //                 Ok(
// //                     Self::InitializeCustomizablePool(
// //                         InitializeCustomizablePoolIxArgs::deserialize(&mut reader)?,
// //                     ),
// //                 )
// //             }
...
// //                 Ok(
// //                     Self::PermanentLockPosition(
// //                         PermanentLockPositionIxArgs::deserialize(&mut reader)?,
// //                     ),
// //                 )
// //             }
...
// //                 Ok(
// //                     Self::RemoveAllLiquidity(
// //                         RemoveAllLiquidityIxArgs::deserialize(&mut reader)?,
// //                     ),
// //                 )
// //             }
...
//     }
// }
// impl<'me, 'info> From<&'me [AccountInfo<'info>; CLAIM_PARTNER_FEE_IX_ACCOUNTS_LEN]>
//     for ClaimPartnerFeeAccounts<'me, 'info>
// {
...
//             return Err(std::io::Error::other(format!(
//                 "discm does not match. Expected: {CLAIM_PARTNER_FEE_IX_DISCM:?}. Received: {maybe_discm:?}"
//             )));
//         }
...
//     })
// }
// pub fn claim_partner_fee_ix(keys: ClaimPartnerFeeKeys, args: ClaimPartnerFeeIxArgs) -> std::io::Result<Instruction> {
//     claim_partner_fee_ix_with_program_id(super::ID, keys, args)
// }
...
//     }
// }
// impl<'me, 'info> From<&'me [AccountInfo<'info>; CLAIM_POSITION_FEE_IX_ACCOUNTS_LEN]>
//     for ClaimPositionFeeAccounts<'me, 'info>
// {
...
// #[derive(Clone, Debug, PartialEq)]
// pub struct ClaimPositionFeeIxData;
...
//             return Err(std::io::Error::other(format!(
//                 "discm does not match. Expected: {CLAIM_POSITION_FEE_IX_DISCM:?}. Received: {maybe_discm:?}"
//             )));
//         }
//         Ok(Self)
//     }
...
//         program_id,
//         accounts: Vec::from(metas),
//         data: ClaimPositionFeeIxData.try_to_vec()?,
//     })
// }
// pub fn claim_position_fee_ix(keys: ClaimPositionFeeKeys) -> std::io::Result<Instruction> {
//     claim_position_fee_ix_with_program_id(super::ID, keys)
// }
...
//             return Err(std::io::Error::other(format!(
//                 "discm does not match. Expected: {CLAIM_PROTOCOL_FEE_IX_DISCM:?}. Received: {maybe_discm:?}"
//             )));
//         }
//         Ok(Self)
//     }
...
//     claim_protocol_fee_ix_with_program_id(super::ID, keys)
// }
...
//             return Err(std::io::Error::other(format!(
//                 "discm does not match. Expected: {CLOSE_CLAIM_FEE_OPERATOR_IX_DISCM:?}. Received: {maybe_discm:?}"
//             )));
//         }
//         Ok(Self)
//     }
...
//     })
// }
// // pub fn close_claim_fee_operator_invoke(accounts: CloseClaimFeeOperatorAccounts<'_, '_>) -> ProgramResult {
// //     close_claim_fee_operator_invoke_with_program_id(super::ID, accounts)
// // }
...
// //     seeds: &[&[&[u8]]],
// // ) -> ProgramResult {
// //     close_claim_fee_operator_invoke_signed_with_program_id(super::ID, accounts, seeds)
// // }
...
//             return Err(std::io::Error::other(format!(
//                 "discm does not match. Expected: {CLOSE_CONFIG_IX_DISCM:?}. Received: {maybe_discm:?}"
//             )));
//         }
//         Ok(Self)
//     }
...
//     }
// }
// pub fn close_config_ix_with_program_id(program_id: Pubkey, keys: CloseConfigKeys) -> std::io::Result<Instruction> {
...
//     close_config_ix_with_program_id(super::ID, keys)
// }
...
//             return Err(std::io::Error::other(format!(
//                 "discm does not match. Expected: {CREATE_CLAIM_FEE_OPERATOR_IX_DISCM:?}. Received: {maybe_discm:?}"
//             )));
//         }
//         Ok(Self)
//     }
...
//     })
// }
// pub fn create_claim_fee_operator_ix(keys: CreateClaimFeeOperatorKeys) -> std::io::Result<Instruction> {
//     create_claim_fee_operator_ix_with_program_id(super::ID, keys)
// }
...
//             return Err(std::io::Error::other(format!(
//                 "discm does not match. Expected: {CREATE_CONFIG_IX_DISCM:?}. Received: {maybe_discm:?}"
//             )));
//         }
...
//     })
// }
// pub fn create_config_ix(keys: CreateConfigKeys, args: CreateConfigIxArgs) -> std::io::Result<Instruction> {
//     create_config_ix_with_program_id(super::ID, keys, args)
// }
...
// #[derive(Clone, Debug, PartialEq)]
// pub struct CreatePositionIxData;
...
//         program_id,
//         accounts: Vec::from(metas),
//         data: CreatePositionIxData.try_to_vec()?,
//     })
// }
// pub fn create_position_ix(keys: CreatePositionKeys) -> std::io::Result<Instruction> {
//     create_position_ix_with_program_id(super::ID, keys)
// }
...
//             return Err(std::io::Error::other(format!(
//                 "discm does not match. Expected: {CREATE_TOKEN_BADGE_IX_DISCM:?}. Received: {maybe_discm:?}"
//             )));
//         }
//         Ok(Self)
//     }
...
//     })
// }
// pub fn create_token_badge_ix(keys: CreateTokenBadgeKeys) -> std::io::Result<Instruction> {
//     create_token_badge_ix_with_program_id(super::ID, keys)
// }
...
//     })
// }
// pub fn fund_reward_ix(keys: FundRewardKeys, args: FundRewardIxArgs) -> std::io::Result<Instruction> {
//     fund_reward_ix_with_program_id(super::ID, keys, args)
// }
...
// ) -> Result<(), (&'me AccountInfo<'info>, ProgramError)> {
//     for should_be_writable in [accounts.pool, accounts.reward_vault, accounts.funder_token_account] {
//         if !should_be_writable.is_writable {
//             return Err((should_be_writable, ProgramError::InvalidAccountData));
//         }
//     }
...
// //     pub program: Pubkey,
// // }
// // impl From<InitializeCustomizablePoolAccounts<'_, '_>>
// // for InitializeCustomizablePoolKeys {
...
// //     }
// // }
// // impl From<InitializeCustomizablePoolKeys>
// // for [AccountMeta; INITIALIZE_CUSTOMIZABLE_POOL_IX_ACCOUNTS_LEN] {
...
// //     }
// // }
// // impl From<[Pubkey; INITIALIZE_CUSTOMIZABLE_POOL_IX_ACCOUNTS_LEN]>
// // for InitializeCustomizablePoolKeys {
...
// //     }
// // }
// // impl<'info> From<InitializeCustomizablePoolAccounts<'_, 'info>>
// // for [AccountInfo<'info>; INITIALIZE_CUSTOMIZABLE_POOL_IX_ACCOUNTS_LEN] {
...
// //     'me,
// //     'info,
// // > From<&'me [AccountInfo<'info>; INITIALIZE_CUSTOMIZABLE_POOL_IX_ACCOUNTS_LEN]>
// // for InitializeCustomizablePoolAccounts<'me, 'info> {
// //     fn from(
// //         arr: &'me [AccountInfo<'info>; INITIALIZE_CUSTOMIZABLE_POOL_IX_ACCOUNTS_LEN],
// //     ) -> Self {
// //         Self {
// //             creator: &arr[0],
// //             position_nft_mint: &arr[1],
...
// //     pub params: InitializeCustomizablePoolAccounts,
// // }
...
// //     args: InitializeCustomizablePoolIxArgs,
// // ) -> std::io::Result<Instruction> {
// //     initialize_customizable_pool_ix_with_program_id(super::ID, keys, args)
// // }
...
// //     args: InitializeCustomizablePoolIxArgs,
// // ) -> ProgramResult {
// //     initialize_customizable_pool_invoke_with_program_id(super::ID, accounts, args)
// // }
...
// //     seeds: &[&[&[u8]]],
// // ) -> ProgramResult {
// //     initialize_customizable_pool_invoke_signed_with_program_id(
// //         super::ID,
// //         accounts,
// //         args,
// //         seeds,
...
// //     args: InitializePoolIxArgs,
// // ) -> std::io::Result<Instruction> {
// //     initialize_pool_ix_with_program_id(super::ID, keys, args)
// // }
...
// //     args: InitializePoolIxArgs,
// // ) -> ProgramResult {
// //     initialize_pool_invoke_with_program_id(super::ID, accounts, args)
// // }
...
// //     seeds: &[&[&[u8]]],
// // ) -> ProgramResult {
// //     initialize_pool_invoke_signed_with_program_id(super::ID, accounts, args, seeds)
// // }
...
//             return Err(std::io::Error::other(format!(
//                 "discm does not match. Expected: {LOCK_POSITION_IX_DISCM:?}. Received: {maybe_discm:?}"
//             )));
//         }
...
//     })
// }
// pub fn lock_position_ix(keys: LockPositionKeys, args: LockPositionIxArgs) -> std::io::Result<Instruction> {
//     lock_position_ix_with_program_id(super::ID, keys, args)
// }
...
//     }
// }
// impl<'info> From<PermanentLockPositionAccounts<'_, 'info>>
//     for [AccountInfo<'info>; PERMANENT_LOCK_POSITION_IX_ACCOUNTS_LEN]
// {
...
//     }
// }
// impl<'me, 'info> From<&'me [AccountInfo<'info>; PERMANENT_LOCK_POSITION_IX_ACCOUNTS_LEN]>
//     for PermanentLockPositionAccounts<'me, 'info>
// {
...
//             return Err(std::io::Error::other(format!(
//                 "discm does not match. Expected: {PERMANENT_LOCK_POSITION_IX_DISCM:?}. Received: {maybe_discm:?}"
//             )));
//         }
...
//     args: PermanentLockPositionIxArgs,
// ) -> std::io::Result<Instruction> {
//     permanent_lock_position_ix_with_program_id(super::ID, keys, args)
// }
...
//     }
// }
// impl<'me, 'info> From<&'me [AccountInfo<'info>; REFRESH_VESTING_IX_ACCOUNTS_LEN]>
//     for RefreshVestingAccounts<'me, 'info>
// {
...
// #[derive(Clone, Debug, PartialEq)]
// pub struct RefreshVestingIxData;
...
//             return Err(std::io::Error::other(format!(
//                 "discm does not match. Expected: {REFRESH_VESTING_IX_DISCM:?}. Received: {maybe_discm:?}"
//             )));
//         }
//         Ok(Self)
//     }
...
//         program_id,
//         accounts: Vec::from(metas),
//         data: RefreshVestingIxData.try_to_vec()?,
//     })
// }
// pub fn refresh_vesting_ix(keys: RefreshVestingKeys) -> std::io::Result<Instruction> {
//     refresh_vesting_ix_with_program_id(super::ID, keys)
// }
...
//     }
// }
// impl<'me, 'info> From<&'me [AccountInfo<'info>; SET_POOL_STATUS_IX_ACCOUNTS_LEN]>
//     for SetPoolStatusAccounts<'me, 'info>
// {
...
//             return Err(std::io::Error::other(format!(
//                 "discm does not match. Expected: {SET_POOL_STATUS_IX_DISCM:?}. Received: {maybe_discm:?}"
//             )));
//         }
...
//     })
// }
// pub fn set_pool_status_ix(keys: SetPoolStatusKeys, args: SetPoolStatusIxArgs) -> std::io::Result<Instruction> {
//     set_pool_status_ix_with_program_id(super::ID, keys, args)
// }

...
pub enum MeteoraDlmmProgramError {
...
impl From<MeteoraDlmmProgramError> for ProgramError {
    fn from(e: MeteoraDlmmProgramError) -> Self {
        ProgramError::Custom(e as u32)
    }
}
impl<T> DecodeError<T> for MeteoraDlmmProgramError {
    fn type_of() -> &'static str {
        "MeteoraDlmmProgramError"
    }
}
impl PrintProgramError for MeteoraDlmmProgramError {
    fn print<E>(&self)
    where

...
pub enum MeteoraDlmmProgramProgramIx {
...
impl MeteoraDlmmProgramProgramIx {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        let mut reader = buf;
        let mut maybe_discm = [0u8; 8];
        reader.read_exact(&mut maybe_discm)?;
        match maybe_discm {
            INITIALIZE_LB_PAIR_IX_DISCM => Ok(Self::InitializeLbPair(InitializeLbPairIxArgs::deserialize(
                &mut reader,
            )?)),
            ...
            INITIALIZE_BIN_ARRAY_BITMAP_EXTENSION_IX_DISCM => Ok(Self::InitializeBinArrayBitmapExtension),
            ...
            ADD_LIQUIDITY_ONE_SIDE_IX_DISCM => Ok(Self::AddLiquidityOneSide(AddLiquidityOneSideIxArgs::deserialize(
                &mut reader,
            )?)),
            REMOVE_LIQUIDITY_IX_DISCM => Ok(Self::RemoveLiquidity(RemoveLiquidityIxArgs::deserialize(&mut reader)?)),
            INITIALIZE_POSITION_IX_DISCM => Ok(Self::InitializePosition(InitializePositionIxArgs::deserialize(
                &mut reader,
            )?)),
            ...
            SWAP_WITH_PRICE_IMPACT_IX_DISCM => Ok(Self::SwapWithPriceImpact(SwapWithPriceImpactIxArgs::deserialize(
                &mut reader,
            )?)),
            WITHDRAW_PROTOCOL_FEE_IX_DISCM => Ok(Self::WithdrawProtocolFee(WithdrawProtocolFeeIxArgs::deserialize(
                &mut reader,
            )?)),
            INITIALIZE_REWARD_IX_DISCM => Ok(Self::InitializeReward(InitializeRewardIxArgs::deserialize(
                &mut reader,
            )?)),
            FUND_REWARD_IX_DISCM => Ok(Self::FundReward(FundRewardIxArgs::deserialize(&mut reader)?)),
            UPDATE_REWARD_FUNDER_IX_DISCM => Ok(Self::UpdateRewardFunder(UpdateRewardFunderIxArgs::deserialize(
                &mut reader,
            )?)),
            UPDATE_REWARD_DURATION_IX_DISCM => Ok(Self::UpdateRewardDuration(UpdateRewardDurationIxArgs::deserialize(
                &mut reader,
            )?)),
            ...
            UPDATE_FEE_PARAMETERS_IX_DISCM => Ok(Self::UpdateFeeParameters(UpdateFeeParametersIxArgs::deserialize(
                &mut reader,
            )?)),
            INCREASE_ORACLE_LENGTH_IX_DISCM => Ok(Self::IncreaseOracleLength(IncreaseOracleLengthIxArgs::deserialize(
                &mut reader,
            )?)),
            ...
            SET_ACTIVATION_POINT_IX_DISCM => Ok(Self::SetActivationPoint(SetActivationPointIxArgs::deserialize(
                &mut reader,
            )?)),
...
impl<'info> From<InitializeLbPairAccounts<'_, 'info>> for [AccountInfo<'info>; INITIALIZE_LB_PAIR_IX_ACCOUNTS_LEN] {
...
pub fn initialize_lb_pair_ix(keys: InitializeLbPairKeys, args: InitializeLbPairIxArgs) -> std::io::Result<Instruction> {
    initialize_lb_pair_ix_with_program_id(super::ID, keys, args)
}
...
impl From<InitializePermissionLbPairKeys> for [AccountMeta; INITIALIZE_PERMISSION_LB_PAIR_IX_ACCOUNTS_LEN] {
...
impl From<[Pubkey; INITIALIZE_PERMISSION_LB_PAIR_IX_ACCOUNTS_LEN]> for InitializePermissionLbPairKeys {
...
pub fn initialize_permission_lb_pair_ix(
    ...
    initialize_permission_lb_pair_ix_with_program_id(super::ID, keys, args)
}
...
impl From<[Pubkey; INITIALIZE_CUSTOMIZABLE_PERMISSIONLESS_LB_PAIR_IX_ACCOUNTS_LEN]>
    for InitializeCustomizablePermissionlessLbPairKeys
{
    fn from(pubkeys: [Pubkey; INITIALIZE_CUSTOMIZABLE_PERMISSIONLESS_LB_PAIR_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            lb_pair: pubkeys[0],
            bin_array_bitmap_extension: pubkeys[1],
            token_mint_x: pubkeys[2],
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; INITIALIZE_CUSTOMIZABLE_PERMISSIONLESS_LB_PAIR_IX_ACCOUNTS_LEN]>
    for InitializeCustomizablePermissionlessLbPairAccounts<'me, 'info>
{
    fn from(arr: &'me [AccountInfo<'info>; INITIALIZE_CUSTOMIZABLE_PERMISSIONLESS_LB_PAIR_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            lb_pair: &arr[0],
            bin_array_bitmap_extension: &arr[1],
            token_mint_x: &arr[2],
...
pub const INITIALIZE_CUSTOMIZABLE_PERMISSIONLESS_LB_PAIR_IX_DISCM: [u8; 8] = [46, 39, 41, 135, 111, 183, 200, 64];
#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq)]
pub struct InitializeCustomizablePermissionlessLbPairIxArgs {
    pub params: CustomizableParams,
}
#[derive(Clone, Debug, PartialEq)]
pub struct InitializeCustomizablePermissionlessLbPairIxData(pub InitializeCustomizablePermissionlessLbPairIxArgs);
impl From<InitializeCustomizablePermissionlessLbPairIxArgs> for InitializeCustomizablePermissionlessLbPairIxData {
...
impl InitializeCustomizablePermissionlessLbPairIxData {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        ...
        Ok(Self(InitializeCustomizablePermissionlessLbPairIxArgs::deserialize(
            &mut reader,
        )?))
    }
    pub fn serialize<W: std::io::Write>(&self, mut writer: W) -> std::io::Result<()> {
...
pub fn initialize_customizable_permissionless_lb_pair_ix_with_program_id(
    ...
    let metas: [AccountMeta; INITIALIZE_CUSTOMIZABLE_PERMISSIONLESS_LB_PAIR_IX_ACCOUNTS_LEN] = keys.into();
...
pub fn initialize_customizable_permissionless_lb_pair_ix(
    ...
    initialize_customizable_permissionless_lb_pair_ix_with_program_id(super::ID, keys, args)
}
...
impl From<InitializeBinArrayBitmapExtensionAccounts<'_, '_>> for InitializeBinArrayBitmapExtensionKeys {
...
impl From<[Pubkey; INITIALIZE_BIN_ARRAY_BITMAP_EXTENSION_IX_ACCOUNTS_LEN]> for InitializeBinArrayBitmapExtensionKeys {
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; INITIALIZE_BIN_ARRAY_BITMAP_EXTENSION_IX_ACCOUNTS_LEN]>
    for InitializeBinArrayBitmapExtensionAccounts<'me, 'info>
{
    fn from(arr: &'me [AccountInfo<'info>; INITIALIZE_BIN_ARRAY_BITMAP_EXTENSION_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            lb_pair: &arr[0],
            bin_array_bitmap_extension: &arr[1],
            funder: &arr[2],
...
pub const INITIALIZE_BIN_ARRAY_BITMAP_EXTENSION_IX_DISCM: [u8; 8] = [47, 157, 226, 180, 12, 240, 33, 71];
#[derive(Clone, Debug, PartialEq)]
...
pub fn initialize_bin_array_bitmap_extension_ix(
    ...
    initialize_bin_array_bitmap_extension_ix_with_program_id(super::ID, keys)
}
...
pub fn add_liquidity_by_weight_ix(
    ...
    add_liquidity_by_weight_ix_with_program_id(super::ID, keys, args)
}
...
pub fn add_liquidity_by_strategy_ix(
    ...
    add_liquidity_by_strategy_ix_with_program_id(super::ID, keys, args)
}
...
impl From<AddLiquidityByStrategyOneSideKeys> for [AccountMeta; ADD_LIQUIDITY_BY_STRATEGY_ONE_SIDE_IX_ACCOUNTS_LEN] {
...
impl From<[Pubkey; ADD_LIQUIDITY_BY_STRATEGY_ONE_SIDE_IX_ACCOUNTS_LEN]> for AddLiquidityByStrategyOneSideKeys {
...
{
    fn from(arr: &'me [AccountInfo<'info>; ADD_LIQUIDITY_BY_STRATEGY_ONE_SIDE_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            position: &arr[0],
            lb_pair: &arr[1],
            bin_array_bitmap_extension: &arr[2],
...
pub const ADD_LIQUIDITY_BY_STRATEGY_ONE_SIDE_IX_DISCM: [u8; 8] = [41, 5, 238, 175, 100, 225, 6, 205];
#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq)]
...
pub fn add_liquidity_by_strategy_one_side_ix(
    ...
    add_liquidity_by_strategy_one_side_ix_with_program_id(super::ID, keys, args)
}
...
pub fn add_liquidity_one_side_ix(
    ...
    add_liquidity_one_side_ix_with_program_id(super::ID, keys, args)
}
...
impl<'info> From<InitializePositionAccounts<'_, 'info>> for [AccountInfo<'info>; INITIALIZE_POSITION_IX_ACCOUNTS_LEN] {
...
pub fn initialize_position_ix(
    ...
    initialize_position_ix_with_program_id(super::ID, keys, args)
}
...
pub fn initialize_position_pda_ix(
    ...
    initialize_position_pda_ix_with_program_id(super::ID, keys, args)
}
...
impl From<InitializePositionByOperatorKeys> for [AccountMeta; INITIALIZE_POSITION_BY_OPERATOR_IX_ACCOUNTS_LEN] {
...
impl From<[Pubkey; INITIALIZE_POSITION_BY_OPERATOR_IX_ACCOUNTS_LEN]> for InitializePositionByOperatorKeys {
...
{
    fn from(arr: &'me [AccountInfo<'info>; INITIALIZE_POSITION_BY_OPERATOR_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            payer: &arr[0],
            base: &arr[1],
            position: &arr[2],
...
pub const INITIALIZE_POSITION_BY_OPERATOR_IX_DISCM: [u8; 8] = [251, 189, 190, 244, 117, 254, 35, 148];
#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq)]
...
pub fn initialize_position_by_operator_ix(
    ...
    initialize_position_by_operator_ix_with_program_id(super::ID, keys, args)
}
...
pub fn update_position_operator_ix(
    ...
    update_position_operator_ix_with_program_id(super::ID, keys, args)
}
...
pub fn initialize_reward_ix(keys: InitializeRewardKeys, args: InitializeRewardIxArgs) -> std::io::Result<Instruction> {
    initialize_reward_ix_with_program_id(super::ID, keys, args)
}
...
pub fn update_reward_funder_ix(
    ...
    update_reward_funder_ix_with_program_id(super::ID, keys, args)
}
...
pub fn update_reward_duration_ix(
    ...
    update_reward_duration_ix_with_program_id(super::ID, keys, args)
}
...
pub fn claim_reward_ix(keys: ClaimRewardKeys, args: ClaimRewardIxArgs) -> std::io::Result<Instruction> {
    claim_reward_ix_with_program_id(super::ID, keys, args)
}
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; CLAIM_FEE_IX_ACCOUNTS_LEN]> for ClaimFeeAccounts<'me, 'info> {
...
pub fn claim_fee_ix_with_program_id(program_id: Pubkey, keys: ClaimFeeKeys) -> std::io::Result<Instruction> {
...
pub fn claim_fee_ix(keys: ClaimFeeKeys) -> std::io::Result<Instruction> {
    claim_fee_ix_with_program_id(super::ID, keys)
}
...
pub const UPDATE_FEE_PARAMETERS_IX_DISCM: [u8; 8] = [128, 128, 208, 91, 246, 53, 31, 176];
#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq)]
...
impl UpdateFeeParametersIxData {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        ...
        if maybe_discm != UPDATE_FEE_PARAMETERS_IX_DISCM {
            return Err(std::io::Error::other(format!(
                "discm does not match. Expected: {UPDATE_FEE_PARAMETERS_IX_DISCM:?}. Received: {maybe_discm:?}"
            )));
        }
...
pub fn update_fee_parameters_ix(
    ...
    update_fee_parameters_ix_with_program_id(super::ID, keys, args)
}
...
pub fn increase_oracle_length_ix(
    ...
    increase_oracle_length_ix_with_program_id(super::ID, keys, args)
}
...
impl From<InitializePresetParameterKeys> for [AccountMeta; INITIALIZE_PRESET_PARAMETER_IX_ACCOUNTS_LEN] {
...
pub fn initialize_preset_parameter_ix(
    ...
    initialize_preset_parameter_ix_with_program_id(super::ID, keys, args)
}
...
pub fn close_preset_parameter_ix(keys: ClosePresetParameterKeys) -> std::io::Result<Instruction> {
    close_preset_parameter_ix_with_program_id(super::ID, keys)
}
...
pub fn close_preset_parameter_verify_writable_privileges<'me, 'info>(
    ...
    for should_be_writable in [accounts.preset_parameter, accounts.admin, accounts.rent_receiver] {
        if !should_be_writable.is_writable {
            return Err((should_be_writable, ProgramError::InvalidAccountData));
        }
    }
...
impl<'info> From<TogglePairStatusAccounts<'_, 'info>> for [AccountInfo<'info>; TOGGLE_PAIR_STATUS_IX_ACCOUNTS_LEN] {
...
impl TogglePairStatusIxData {
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        ...
        if maybe_discm != TOGGLE_PAIR_STATUS_IX_DISCM {
            return Err(std::io::Error::other(format!(
                "discm does not match. Expected: {TOGGLE_PAIR_STATUS_IX_DISCM:?}. Received: {maybe_discm:?}"
            )));
        }
        Ok(Self)
    }
...
pub fn toggle_pair_status_ix(keys: TogglePairStatusKeys) -> std::io::Result<Instruction> {
    toggle_pair_status_ix_with_program_id(super::ID, keys)
}
...
impl<'info> From<MigratePositionAccounts<'_, 'info>> for [AccountInfo<'info>; MIGRATE_POSITION_IX_ACCOUNTS_LEN] {
...
pub fn migrate_position_ix(keys: MigratePositionKeys) -> std::io::Result<Instruction> {
    migrate_position_ix_with_program_id(super::ID, keys)
}
...
impl<'info> From<MigrateBinArrayAccounts<'_, 'info>> for [AccountInfo<'info>; MIGRATE_BIN_ARRAY_IX_ACCOUNTS_LEN] {
...
pub fn migrate_bin_array_ix(keys: MigrateBinArrayKeys) -> std::io::Result<Instruction> {
    migrate_bin_array_ix_with_program_id(super::ID, keys)
}
...
pub fn update_fees_and_rewards_ix(keys: UpdateFeesAndRewardsKeys) -> std::io::Result<Instruction> {
    update_fees_and_rewards_ix_with_program_id(super::ID, keys)
}
...
pub fn withdraw_ineligible_reward_ix(
    ...
    withdraw_ineligible_reward_ix_with_program_id(super::ID, keys, args)
}
...
impl<'info> From<SetActivationPointAccounts<'_, 'info>> for [AccountInfo<'info>; SET_ACTIVATION_POINT_IX_ACCOUNTS_LEN] {
...
pub fn set_activation_point_ix(
    ...
    set_activation_point_ix_with_program_id(super::ID, keys, args)
}
pub fn set_activation_point_verify_account_keys(
    accounts: SetActivationPointAccounts<'_, '_>,
    keys: SetActivationPointKeys,
) -> Result<(), (Pubkey, Pubkey)> {
    for (actual, expected) in [(*accounts.lb_pair.key, keys.lb_pair), (*accounts.admin.key, keys.admin)] {
        if actual != expected {
            return Err((actual, expected));
        }
    }
...
impl From<AddLiquidityOneSidePreciseKeys> for [AccountMeta; ADD_LIQUIDITY_ONE_SIDE_PRECISE_IX_ACCOUNTS_LEN] {
...
impl From<[Pubkey; ADD_LIQUIDITY_ONE_SIDE_PRECISE_IX_ACCOUNTS_LEN]> for AddLiquidityOneSidePreciseKeys {
...
{
    fn from(arr: &'me [AccountInfo<'info>; ADD_LIQUIDITY_ONE_SIDE_PRECISE_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            position: &arr[0],
            lb_pair: &arr[1],
            bin_array_bitmap_extension: &arr[2],
...
impl<'info> From<GoToABinAccounts<'_, 'info>> for [AccountInfo<'info>; GO_TO_A_BIN_IX_ACCOUNTS_LEN] {
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; GO_TO_A_BIN_IX_ACCOUNTS_LEN]> for GoToABinAccounts<'me, 'info> {
...
impl From<SetPreActivationDurationKeys> for [AccountMeta; SET_PRE_ACTIVATION_DURATION_IX_ACCOUNTS_LEN] {
...
impl From<SetPreActivationSwapAddressKeys> for [AccountMeta; SET_PRE_ACTIVATION_SWAP_ADDRESS_IX_ACCOUNTS_LEN] {
...
impl From<[Pubkey; SET_PRE_ACTIVATION_SWAP_ADDRESS_IX_ACCOUNTS_LEN]> for SetPreActivationSwapAddressKeys {
...
{
    fn from(arr: &'me [AccountInfo<'info>; SET_PRE_ACTIVATION_SWAP_ADDRESS_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            lb_pair: &arr[0],
            creator: &arr[1],
        }
